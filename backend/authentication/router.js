...
router.patch('/api/auth/login-confirm',authentication.confirmTwoFactor);
router.post('/api/auth/logout', deactivateToken);
router.post('/api/auth/password-reset', authentication.passwordReset);
router.post('/api/auth/password-reset/:invitationCode', authentication.resetConfirmation);
